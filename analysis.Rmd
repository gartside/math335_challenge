...
```
The rise in popularity seen in the first graph from 1910 to the early 1940s is deceptive since it does not take into account the growing number of births each year.  From the second graph, we see that the popularity of the name James was did not vary much between 1910 and the early 1930s, and that it most popular between the years 1936 and 1945,
and has declined in popularity since 1945.
